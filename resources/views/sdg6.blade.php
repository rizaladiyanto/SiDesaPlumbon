            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-6 md:px-12">
                    <div class="max-w-5xl mx-auto text-center fade-in-up">
                        <h2 class="text-2xl md:text-4xl font-bold text-gray-800 mb-6">SDG 6: Air Bersih dan Sanitasi Layak</h2>
                        <div class="w-24 h-1 bg-black mx-auto mb-8"></div>
                        <p class="text-xs md:text-lg text-gray-600 leading-relaxed mb-8 text-justify">
        ...
        <section class="py-8 md:py-16 bg-gray-50 fade-in-up">
            <div class="container mx-auto px-4 md:px-6 lg:px-12">
                <div class="text-center mb-8 md:mb-12 max-w-5xl mx-auto fade-in-up">
                    <h2 class="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-4">Hasil Analisis SDG 6 Desa Plumbon</h2>
                ...
                <div class="bg-white rounded-lg shadow-lg w-full mx-auto fade-in-up">
                    <div class="bg-gray-900 text-white px-3 md:px-6 py-3 md:py-4">
                        <h3 class="text-sm md:text-lg lg:text-xl font-semibold">Tabel Perbandingan Distribusi Frekuensi Berdasarkan Indikator SDGs Desa 6</h3>
                    </div>
                    ...
                    <div class="overflow-x-auto lg:overflow-x-visible">
                        <table class="w-full">
                            <thead class="bg-gray-50 sticky top-0">
                                <tr>
                                    <th class="px-2 md:px-4 py-2 md:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider sticky left-0 bg-gray-50 z-10">Indikator</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-white z-10">Akses terhadap layanan air minum dan sanitasi layak (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">91.4</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">100</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">90.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">100</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">95.2</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">100</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">100</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">100</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">96.3</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">100</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">97.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap text-green-600 font-semibold">100%</td>
                                </tr>
                                <tr class="bg-gray-50">
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-gray-50 z-10">Keluarga dan industri pengguna fasilitas air limbah dan lumpur tinja (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">1.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">97.8</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">90.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">94.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">92.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">100</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">100</td>
                                    ...
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">98</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">81.6</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap text-green-600 font-semibold">100%</td>
                                </tr>
                                <tr>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-white z-10">Kualitas sumber air tidak berwarna, tidak berbau, tidak berasa (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">17.2</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">15.2</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">24.2</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">5.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">2.4</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">7.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">10</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">8.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">11.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">4</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">10.3</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap text-red-600 font-semibold">0%</td>
                                </tr>
                                <tr class="bg-gray-50">
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-gray-50 z-10">Terdapat perdes/SK kades pelestarian lingkungan di sekitar aliran sungai (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">19</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">21.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">9.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">26.5</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">21.4</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">21.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">56.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">78.3</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">7.4</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">40</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">24.5</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">-</td>
                                </tr>
                                <tr>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-white z-10">Tersedianya Perdes/SK kades pelestarian lingkungan di sekitar aliran sungai (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">51.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">52.2</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">72.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">55.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">35.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">65.8</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">66.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">34.8</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">37</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">52</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">48.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">-</td>
                                </tr>
                                <tr class="bg-gray-50">
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-gray-50 z-10">Tersedianya informasi dari stasiun hidrologi dan klimatologi terdekat (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">37.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">37</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">30.3</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">44.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">23.8</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">50</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">33.3</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">39.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">22.2</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">40</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">36.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">-</td>
                                </tr>
                                <tr>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-white z-10">Tersedianya informasi sumber daya air (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">50</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">37</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">30</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">38.2</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">23.8</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">42.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">16.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">39.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">25.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">62</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">38.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">-</td>
                                </tr>
                                <tr class="bg-gray-50">
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-gray-50 z-10">Jumlah mata air tetap (ya) (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">62.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">58.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">78.8</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">82.4</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">66.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">73.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">70</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">52.2</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">63</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">64</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">66.8</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">-</td>
                                </tr>
                                <tr>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-white z-10">Terdapat kegiatan penanaman pohon di sekitar aliran dan pengerukan sungai (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">17.2</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">23.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">6.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">17.6</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">9.5</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">7.9</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">10</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">13</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">11.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">22</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">16.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">-</td>
                                </tr>
                                <tr class="bg-gray-50">
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-gray-50 z-10">Air danau dan sungai tidak berwarna, tidak berbau, tidak berasa (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">24.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">13</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">9.1</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">32.4</td>
                                    ...
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">16</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">17.4</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap text-red-600 font-semibold">0%</td>
                                </tr>
                                <tr>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium text-gray-900 sticky left-0 bg-white z-10">Tidak ada lahan tandus dan erosi (%)</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">77.6</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">69.6</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">66.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">88.2</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">64.3</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">94.7</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">56.7</td>
                                    ...
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap">82</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">75</td>
                                    <td class="px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm text-center whitespace-nowrap font-semibold">-</td>
                                </tr>
                            </tbody>
                        </table>
